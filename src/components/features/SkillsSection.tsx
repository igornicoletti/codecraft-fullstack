    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div className='relative flex items-center justify-center size-20 md:size-24 rounded-xl border border-secondary/50 bg-linear-to-t from-secondary to-transparent backdrop-blur-md cursor-pointer overflow-hidden transition-all duration-200'
            style={style}
