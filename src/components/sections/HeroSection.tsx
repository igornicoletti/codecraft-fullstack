...
export const HeroSection = () => (
  <section id='hero' className="relative overflow-hidden py-20 md:py-32">
    <div className="container mx-auto px-6">
      ...
      {/* 1. Badge */}
      <AnimatedShinyText className='mb-4 text-muted-foreground lg:text-lg'>
      ...
      <div className="flex justify-center space-x-2 sm:space-x-10">
        {heroData.stacks.map(({ icon: Icon, label }) => (
          <Tooltip key={label}>
            <TooltipTrigger>
              <Icon size={40} stroke={0.5} className='text-muted-foreground hover:text-ring transition-colors' />
            </TooltipTrigger>
