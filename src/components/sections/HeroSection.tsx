...
export const HeroSection = () => (
  <section id='hero' className='relative overflow-hidden py-16 md:py-32'>
    <div className='container mx-auto px-6'>
      {/* 1. Badge */}
      <AnimatedShinyText className='mb-6 md:text-lg text-base text-center text-muted-foreground'>
        <span>{heroData.profile.name}</span>
        <LightningIcon className='text-accent-foreground' />
        <span>{heroData.profile.role}</span>
      </AnimatedShinyText>
      {/* 2. Title */}
      <h1 className='mb-6 xl:text-7xl lg:text-6xl md:text-5xl text-4xl text-center text-pretty'>
