...
export const projectSectionData: ProjectSectionContent = {
  sectionTagline: 'Projetos open source',
  mainHeadline: 'Códigos que falam por si só',
  sectionSummary: 'Explore uma coleção selecionada de projetos que mostram conceitos de aplicações web eficientes, utilizando tecnologias modernas e melhores práticas de desenvolvimento.',
  externalAction: {
    url: 'https://github.com/igornicoletti?tab=repositories',
    buttonText: 'Explorar projetos no GitHub',
  },
  projectList: [
    {
      ...
      repositoryActionText: "Explorar código no GitHub",
    ...
    {
      projectTitle: "My App",
      shortDescription: "Um boilerplate de aplicação full-stack moderna com autenticação completa (login/cadastro), usando Next.js, tRPC e Prisma. Serve como ponto de partida rápido para projetos escaláveis e seguros.",
      repositoryActionText: "Explorar código no GitHub",
      liveDemoUrl: "https://my-app-2ti.vercel.app/login",
      repositoryUrl: "https://github.com/igornicoletti/my-app",
    },
  ]
}
